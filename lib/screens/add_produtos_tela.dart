...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  // NOVO: Controller para o link da imagem da internet
  ...
  Future<void> save() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        Navigator.pop(context, true); // Retorna sinalizando sucesso
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
                        ...
                        if (url.isEmpty) {
                          return const Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text(
                                "Insira a URL abaixo para ver a prévia",
